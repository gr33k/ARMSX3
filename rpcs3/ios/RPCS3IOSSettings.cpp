...
const std::array catalog{
	...
	GAME_SETTING("cpu.stub_ppu_traps", "CPU", "PPU", "Stub PPU Traps", "Skips the selected number of instructions after a continueable PPU trap. Leave at zero unless a title-specific compatibility profile or observed fatal trap requires it.", kind::RPCS3_IOS_SETTING_INTEGER, g_cfg.core.stub_ppu_traps, -64, 64, 1),
