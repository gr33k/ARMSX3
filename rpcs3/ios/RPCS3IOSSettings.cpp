...
const std::array catalog{
	...
	SETTING("cpu.spu_loop_detection", "CPU", "SPU", "SPU Loop Detection", "Detects SPU wait loops and yields the host thread.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.core.spu_loop_detection, 0, 1, 1),
	...
	SETTING("gpu.frame_limit", "GPU", "Display", "Frame Limit", "Limits presentation rate independently of the emulated game clock.", kind::RPCS3_IOS_SETTING_CHOICE, g_cfg.video.frame_limit, 0, 0, 0),
	...
	SETTING("gpu.shader_precision", "GPU", "Rendering", "Shader Precision", "Controls shader precision generated for the host GPU.", kind::RPCS3_IOS_SETTING_CHOICE, g_cfg.video.shader_precision, 0, 0, 0),
	...
	SETTING("gpu.minimum_scalable_dimension", "GPU", "Rendering", "Minimum Scalable Dimension", "Prevents small render targets from being resolution-scaled.", kind::RPCS3_IOS_SETTING_INTEGER, g_cfg.video.min_scalable_dimension, 1, 1024, 1),
	SETTING("gpu.anisotropic_filter", "GPU", "Rendering", "Anisotropic Filter Override", "Overrides anisotropic filtering; zero leaves the game setting unchanged.", kind::RPCS3_IOS_SETTING_CHOICE, g_cfg.video.anisotropic_level_override, 0, 16, 1),
	SETTING("gpu.texture_lod_bias", "GPU", "Rendering", "Texture LOD Bias", "Adds a bias to texture mip-level selection.", kind::RPCS3_IOS_SETTING_DECIMAL, g_cfg.video.texture_lod_bias, -32, 32, 0.25),
	SETTING("gpu.fsr_sharpening", "GPU", "Rendering", "FSR Sharpening", "Sets FidelityFX CAS sharpening intensity.", kind::RPCS3_IOS_SETTING_INTEGER, g_cfg.video.rcas_sharpening_intensity, 0, 100, 1),
	...
	SETTING("gpu.precise_zcull", "GPU", "Rendering", "Precise ZCULL", "Uses precise ZCULL statistics; enabling it disables relaxed ZCULL.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.video.precise_zpass_count, 0, 1, 1),
	SETTING("gpu.relaxed_zcull", "GPU", "Rendering", "Relaxed ZCULL", "Uses the fastest relaxed ZCULL synchronization; enabling it disables precise ZCULL.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.video.relaxed_zcull_sync, 0, 1, 1),
	...
	SETTING("audio.avport", "Audio", "Output", "RSXAudio AV Port", "Selects the emulated AV output used by RSXAudio.", kind::RPCS3_IOS_SETTING_CHOICE, g_cfg.audio.rsxaudio_port, 0, 0, 0),
	SETTING("audio.channel_layout", "Audio", "Output", "Channel Layout", "Chooses how RPCS3 mixes channels before the iOS RemoteIO backend.", kind::RPCS3_IOS_SETTING_CHOICE, g_cfg.audio.channel_layout, 0, 0, 0),
	...
	SETTING("audio.master_volume", "Audio", "Playback", "Master Volume", "Sets RPCS3 output volume before iOS system volume is applied.", kind::RPCS3_IOS_SETTING_INTEGER, g_cfg.audio.volume, 0, 200, 1),
	...
	SETTING("audio.buffer_duration", "Audio", "Playback", "Buffer Duration", "Sets the desired output buffer duration in milliseconds.", kind::RPCS3_IOS_SETTING_INTEGER, g_cfg.audio.desired_buffer_duration, 4, 250, 1),
	...
	// System
	SETTING("system.language", "System", "Console", "System Language", "Sets the language reported by the emulated console.", kind::RPCS3_IOS_SETTING_CHOICE, g_cfg.sys.language, 0, 0, 0),
	...
	SETTING("system.time_offset", "System", "Console", "Console Time Offset", "Offsets emulated console time from the iOS clock, in seconds.", kind::RPCS3_IOS_SETTING_INTEGER, g_cfg.sys.console_time_offset, -3153600000.0, 3153600000.0, 60),
	SETTING("system.empty_hdd_tmp", "System", "Storage", "Clear Temporary Storage", "Empties /dev_hdd0/tmp when a title starts.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.vfs.empty_hdd0_tmp, 0, 1, 1),
	SETTING("system.limit_cache", "System", "Storage", "Limit Disk Cache Size", "Removes old disk-cache entries when the configured limit is exceeded.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.vfs.limit_cache_size, 0, 1, 1),
	SETTING("system.cache_size", "System", "Storage", "Maximum Disk Cache", "Sets the disk-cache limit in megabytes.", kind::RPCS3_IOS_SETTING_INTEGER, g_cfg.vfs.cache_max_size, 0, 10240, 128),
	...
	SETTING("network.dns", "Network", "Connectivity", "DNS Address", "Sets the DNS server used by emulated networking.", kind::RPCS3_IOS_SETTING_TEXT, g_cfg.net.dns, 0, 0, 0),
	SETTING("network.derive_mac", "Network", "Connectivity", "Derive MAC From PSID", "Derives the emulated MAC address from the console PSID.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.net.derive_mac_from_psid, 0, 1, 1),
	...
	SETTING("network.psn_country", "Network", "PlayStation Network", "PSN Country", "Sets the country reported to network services.", kind::RPCS3_IOS_SETTING_CHOICE, g_cfg.net.country, 0, 0, 0),
	...
	SETTING("advanced.ppu_vnan_fixup", "Advanced", "CPU Compatibility", "PPU Vector NaN Handling", "Enables partial correction of PPU vector NaN behavior.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.core.ppu_fix_vnan, 0, 1, 1),
	SETTING("advanced.llvm_precompilation", "Advanced", "CPU Compatibility", "LLVM Precompilation", "Precompiles PPU modules before starting a title.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.core.llvm_precompilation, 0, 1, 1),
	SETTING("advanced.savestate_suspend", "Advanced", "Savestates", "Suspend Emulation Savestate Mode", "Closes emulation while saving and deletes the save after loading.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.savestate.suspend_emu, 0, 1, 1),
	SETTING("advanced.savestate_compatible", "Advanced", "Savestates", "Compatible Savestate Mode", "Improves SPU LLVM savestate reliability. Takes effect on the next boot and can reduce performance.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.savestate.compatible_mode, 0, 1, 1),
	...
	SETTING("advanced.read_depth_buffer", "Advanced", "GPU Compatibility", "Read Depth Buffer", "Allows the CPU to read rendered depth-buffer data.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.video.read_depth_buffer, 0, 1, 1),
	SETTING("advanced.write_depth_buffer", "Advanced", "GPU Compatibility", "Write Depth Buffer", "Mirrors depth-buffer data into emulated memory.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.video.write_depth_buffer, 0, 1, 1),
	...
	SETTING("advanced.disable_texel_remapping", "Advanced", "MoltenVK", "Disable Hardware Color-Space Remapping", "Uses shader-based color-space remapping instead of host hardware paths.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.video.disable_hardware_texel_remapping, 0, 1, 1),
	SETTING("advanced.mfc_shuffling", "Advanced", "Scheduling", "MFC Command Shuffling", "Delays and reorders one MFC command for compatibility.", kind::RPCS3_IOS_SETTING_CHOICE, g_cfg.core.mfc_transfers_shuffling, 0, 1, 1),
	SETTING("advanced.disable_spu_spin", "Advanced", "Scheduling", "Disable SPU Spin Optimization", "Disables GETLLAR spin-loop optimization.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.core.spu_getllar_spin_optimization_disabled, 0, 1, 1),
	SETTING("advanced.spu_busy_loop", "Advanced", "Scheduling", "SPU Reservation Busy Loop", "Enables busy waiting for selected SPU reservation events.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.core.spu_reservation_busy_waiting_enabled, 0, 1, 1),
	...
	// Emulator
	SETTING("emulator.max_llvm_threads", "Emulator", "Compilation", "Maximum LLVM Threads", "Limits concurrent LLVM compilation threads; zero uses all available cores.", kind::RPCS3_IOS_SETTING_INTEGER, g_cfg.core.llvm_threads, 0, 64, 1),
	SETTING("emulator.shader_compiler_threads", "Emulator", "Compilation", "Shader Compiler Threads", "Limits concurrent shader compiler threads; zero is automatic.", kind::RPCS3_IOS_SETTING_INTEGER, g_cfg.video.shader_compiler_threads_count, 0, 16, 1),
	SETTING("emulator.native_interface", "Emulator", "Behavior", "Use Native Interface", "Uses RPCS3's controller-driven in-game overlays instead of desktop dialogs.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.misc.use_native_interface, 0, 1, 1),
	SETTING("emulator.prevent_display_sleep", "Emulator", "Behavior", "Prevent Display Sleep", "Keeps the iOS display awake while emulation is running.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.misc.prevent_display_sleep, 0, 1, 1),
	SETTING("emulator.pause_home_menu", "Emulator", "Behavior", "Pause During Home Menu", "Pauses emulation whenever RPCS3's native home menu is open.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.misc.pause_during_home_menu, 0, 1, 1),
	SETTING("emulator.play_boot_music", "Emulator", "Behavior", "Play Music During Boot", "Plays title-provided music during the boot sequence when available.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.misc.play_music_during_boot, 0, 1, 1),
	SETTING("emulator.start_savestate_paused", "Emulator", "Behavior", "Start Savestate Paused", "Pauses on the first frame after a savestate is loaded.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.savestate.start_paused, 0, 1, 1),
	SETTING("emulator.show_rpcn_popups", "Emulator", "Native Overlays", "Show RPCN Popups", "Shows RPCN friend-list notifications in the native overlay.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.misc.show_rpcn_popups, 0, 1, 1),
	...
	SETTING("emulator.show_pressure_hint", "Emulator", "Native Overlays", "Show Pressure Toggle Hint", "Shows a hint when controller pressure-intensity mode changes.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.misc.show_pressure_intensity_toggle_hint, 0, 1, 1),
	SETTING("emulator.show_limiter_hint", "Emulator", "Native Overlays", "Show Analog Limiter Hint", "Shows a hint when the analog limiter changes.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.misc.show_analog_limiter_toggle_hint, 0, 1, 1),
	...
	SETTING("emulator.perf_framerate_graph", "Emulator", "Performance Overlay", "Framerate Graph", "Shows the framerate history graph.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.video.perf_overlay.framerate_graph_enabled, 0, 1, 1),
	SETTING("emulator.perf_frametime_graph", "Emulator", "Performance Overlay", "Frametime Graph", "Shows the frametime history graph.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.video.perf_overlay.frametime_graph_enabled, 0, 1, 1),
	...
	SETTING("emulator.perf_center_x", "Emulator", "Performance Overlay", "Center Horizontally", "Centers the overlay horizontally and ignores horizontal margin.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.video.perf_overlay.center_x, 0, 1, 1),
	SETTING("emulator.perf_center_y", "Emulator", "Performance Overlay", "Center Vertically", "Centers the overlay vertically and ignores vertical margin.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.video.perf_overlay.center_y, 0, 1, 1),
	SETTING("emulator.perf_window_space", "Emulator", "Performance Overlay", "Use Full Surface", "Allows the overlay to occupy letterboxed space outside the game image.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.video.perf_overlay.use_window_space, 0, 1, 1),
	SETTING("emulator.shader_background", "Emulator", "Shader Loading", "Custom Background", "Allows title artwork behind native shader-loading messages.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.video.shader_preloading_dialog.use_custom_background, 0, 1, 1),
	...
	// Debug
	SETTING("debug.force_high_precision_z", "Debug", "GPU", "Force High Precision Z", "Forces high-precision depth buffers for compatibility testing.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.video.force_high_precision_z_buffer, 0, 1, 1),
	SETTING("debug.vulkan_output", "Debug", "GPU", "Vulkan Debug Output", "Enables additional renderer diagnostics in the Debug tab.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.video.debug_output, 0, 1, 1),
	SETTING("debug.renderer_overlay", "Debug", "GPU", "Renderer Debug Overlay", "Displays internal RSX renderer diagnostics.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.video.debug_overlay, 0, 1, 1),
	...
	SETTING("debug.disable_occlusion", "Debug", "GPU", "Disable Occlusion Queries", "Disables host ZCULL occlusion queries.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.video.disable_zcull_queries, 0, 1, 1),
	...
	SETTING("debug.force_cpu_blit", "Debug", "GPU", "Force CPU Blit", "Moves blit processing from the GPU to the CPU.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.video.force_cpu_blit_processing, 0, 1, 1),
	...
	SETTING("debug.gpu_texture_scaling", "Debug", "GPU", "GPU Texture Scaling", "Moves texture scaling work to the host GPU.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.video.use_gpu_texture_scaling, 0, 1, 1),
	...
	SETTING("debug.emulate_depth_compare", "Debug", "GPU", "Emulate Depth Comparison", "Emulates special depth comparison modes in shaders.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.video.emulate_depth_compare, 0, 1, 1),
	...
	SETTING("debug.framebuffer_aliasing", "Debug", "GPU", "Framebuffer Aliasing Bias", "Chooses how ambiguous framebuffer aliases are interpreted.", kind::RPCS3_IOS_SETTING_CHOICE, g_cfg.video.fb_aliasing_bias, 0, 0, 0),
	...
	SETTING("debug.ppu_saturation", "Debug", "CPU Accuracy", "Accurate PPU Saturation", "Emulates PPU floating-point saturation flags.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.core.ppu_set_sat_bit, 0, 1, 1),
	SETTING("debug.cache_line_stores", "Debug", "CPU Accuracy", "Accurate Cache-Line Stores", "Uses strict semantics for PPU cache-line stores.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.core.accurate_cache_line_stores, 0, 1, 1),
	...
	SETTING("debug.performance_report", "Debug", "CPU", "Performance Report", "Logs unusually slow emulated operations.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.core.perf_report, 0, 1, 1),
	SETTING("debug.ppu_128_loop", "Debug", "CPU Accuracy", "Accurate PPU 128-Byte Reservations", "Sets the maximum loop length that receives accurate 128-byte reservation behavior.", kind::RPCS3_IOS_SETTING_INTEGER, g_cfg.core.ppu_128_reservations_loop_max_length, -1, 14, 1),
	SETTING("debug.ppu_threads", "Debug", "CPU", "PPU Threads", "Sets the number of simultaneously scheduled PPU threads.", kind::RPCS3_IOS_SETTING_INTEGER, g_cfg.core.ppu_threads, 1, 8, 1),
	SETTING("debug.pad_overlay", "Debug", "Input", "Pad Input Overlay", "Displays raw iOS pad input received by RPCS3.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.io.pad_debug_overlay, 0, 1, 1),
};
