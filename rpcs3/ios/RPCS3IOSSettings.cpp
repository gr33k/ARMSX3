...
const std::array catalog{
	...
	SETTING("advanced.savestate_compatible", "Advanced", "Savestates", "Compatible Savestate Mode", "Uses SPU behavior optimized for savestate compatibility.", kind::RPCS3_IOS_SETTING_BOOLEAN, g_cfg.savestate.compatible_mode, 0, 1, 1),
