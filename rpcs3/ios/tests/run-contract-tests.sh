...
"${CXX_COMPILER}" -std=c++20 -Wall -Wextra -Werror \
    ...
    "${SCRIPT_DIR}/IOSExitspawnDiscPathPolicyTests.cpp" \
    -o "${OUTPUT_ROOT}/IOSExitspawnDiscPathPolicyTests"
"${OUTPUT_ROOT}/IOSExitspawnDiscPathPolicyTests"
...
"${CXX_COMPILER}" -std=c++20 -Wall -Wextra -Werror \
    -I "${SOURCE_ROOT}" -I "${SOURCE_ROOT}/rpcs3" \
    "${SCRIPT_DIR}/BlitTargetBoundsPolicyTests.cpp" \
    -o "${OUTPUT_ROOT}/BlitTargetBoundsPolicyTests"
"${OUTPUT_ROOT}/BlitTargetBoundsPolicyTests"
...
"${CXX_COMPILER}" -std=c++20 -Wall -Wextra -Werror \
    -I "${SOURCE_ROOT}" -I "${SOURCE_ROOT}/rpcs3" \
    "${SCRIPT_DIR}/IOSSPUPUTLLC16PolicyTests.cpp" \
    -o "${OUTPUT_ROOT}/IOSSPUPUTLLC16PolicyTests"
"${OUTPUT_ROOT}/IOSSPUPUTLLC16PolicyTests"
