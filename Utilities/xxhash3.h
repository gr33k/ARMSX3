...
/* Standalone xxHash 0.8.2 header snapshot from the pinned zstd 1.5.7
 * submodule. The zstd-owned copy disables XXH3 and prefixes its public API;
 * this RPCS3-owned copy retains upstream's header-only XXH3 implementation. */
